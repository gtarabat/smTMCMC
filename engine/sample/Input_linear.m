...
function sys_para = Input_linear( method, param )
...
sys_para.model_folder = '../functions/linear';
sys_para.data_folder = '../../data/linear/';

%% Load ODE synthetic data
d = load( [ sys_para.data_folder 'data.mat' ] );
data = d.data;
...
switch method
    case 'BASIS'
        loglike_function = 'linear_loglike';
        sys_para.cov_check.method   = 'BASIS';
           
    case 'smMALA'
        loglike_function = 'linear_loglike_smMALA';
    ...
    case {'pMALA'}
        error("no likelihood functions implemented for pMala");
        

    case 'SN'
        error("no likelihood functions implemented for SN");
...
% set seed to shuffle or to an integer value
